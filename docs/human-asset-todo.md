...
> Aseprite / GIMP 等で 32 × 256 のドット絵を描き、32 px ごとのグリッドに面ごとのパターンを配置する。
...
|---|---|---|---|---|
| ✅ | CRTmonitor.glb | ブラウン管モニター | 0.4×0.3×0.3 | 64×64 |
| ✅ | desk.glb | デスク | 1.5×1×0.75 | 128×128 |
| ✅ | deskLong.glb | 長机 | 2×0.5×0.75 | 128×128 |
| ✅ | monitor.glb | 液晶モニター | 0.5×0.4×0.1 | 64×64 |
| ✅ | outdoorUnit.glb | 室外機 | 0.7×0.3×0.6 | 64×64 |
| ✅ | step.glb | 階段 | 1×1×0.25 | 64×64 |
| ✅ | stool.glb | スツール | 0.4×0.4×0.5 | 64×64 |
| ✅ | tree.glb | 木 | 0.5×0.5×5 | 128×128 |
| ✅ | ventilationFan.glb | 室外機（装飾） | 0×0×0 | 64×64 |
...
| ✅ | 作業 | 内容 |
|---|---|---|
| ☐ | URL を確定する | 例: `https://loresworld.example.com/terms` / `https://loresworld.example.com/privacy` |
