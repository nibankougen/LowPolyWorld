...
/// <summary>
/// マイワールドオブジェクト（ユーザーアップロード GLB）のスロットを管理するロジッククラス。
/// 通常ユーザー: 最大 10 スロット / プレミアム: 最大 100 スロット。
/// プレミアム解約後は既存スロットを保持するが上限を超えた状態では新規追加をブロックする。
/// </summary>
public class MyObjectSlotManager
{
    ...
    public MyObjectSlotManager(IEnumerable<string> existingSlotIds, bool isPremium)
    {
